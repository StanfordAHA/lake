...
if __name__ == "__main__":
    ...
    # Need to get the corners for all information to send on...
    ...
    # Use the local gen_srams.sh (fixes the ADK version's hardcoded S1DB family)
    subprocess.run(["bash", "gen_srams.sh", result, result_type])
