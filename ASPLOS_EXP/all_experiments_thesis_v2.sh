...
python ASPLOS_EXP/create_mflowgen_experiments.py \
    --build_dir /sim/mstrange/THESIS_BUILDS_V2/ITERATION_DOMAIN_EXP \
    --design_filter thesis_sweep --physical --run_builds \
    --fetch_width 1 \
    --data_width 16 \
...
python ASPLOS_EXP/create_mflowgen_experiments.py \
    --build_dir /sim/mstrange/THESIS_BUILDS_V2/AFFINE_PATTERN_GENERATOR_EXP \
    --design_filter thesis_sweep --physical --run_builds \
    --fetch_width 1 \
    --data_width 16 \
    --dimensionality 1 2 3 4 5 6 \
...
python ASPLOS_EXP/create_mflowgen_experiments.py \
    --build_dir /sim/mstrange/THESIS_BUILDS_V2/MEMORY_EXP \
    --design_filter thesis_sweep --physical --run_builds \
    --fetch_width 1 \
    --dual_port \
    --in_ports 1 \
