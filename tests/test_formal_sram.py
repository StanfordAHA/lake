...
def test_formal_sram():
    ...
    config["strg_ub_sram_only_input_addr_gen_0_strides_0"] = 170
    ...
    config["strg_ub_sram_only_output_addr_gen_1_starting_addr"] = 495
    ...
    config["strg_ub_sram_only_output_addr_gen_1_strides_0"] = 341
    ...
    config["strg_ub_sram_tb_shared_output_sched_gen_1_sched_addr_gen_strides_0"] = 2
    ...
    config["strg_ub_sram_only_output_addr_gen_0_starting_addr"] = 329
    ...
    config["strg_ub_sram_only_input_addr_gen_0_starting_addr"] = 329
    ...
    config["strg_ub_sram_tb_shared_loops_buf2out_autovec_read_1_ranges_0"] = 361
    ...
    config["strg_ub_sram_only_output_addr_gen_0_strides_0"] = 170
