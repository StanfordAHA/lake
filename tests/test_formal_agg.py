...
def test_agg():
    ...
    config["agg_write_loops_1_ranges_1"] = 1
    config["agg_write_loops_1_ranges_2"] = 0
    config["agg_write_loops_1_ranges_3"] = 65535
    ...
    config["agg_write_addr_gen_0_strides_2"] = 7
    config["agg_write_addr_gen_0_strides_3"] = 65531
    config["agg_write_addr_gen_0_strides_4"] = 0
    config["agg_write_addr_gen_0_strides_5"] = 1
    config["port_sel_addr_starting_addr"] = 0
    config["agg_write_sched_gen_1_sched_addr_gen_starting_addr"] = 0
    config["agg_write_loops_1_dimensionality"] = 2
    ...
    config["agg_read_addr_gen_1_starting_addr"] = 0
    config["agg_write_loops_0_dimensionality"] = 3
    ...
    config["agg_write_addr_gen_1_starting_addr"] = 65535
    config["agg_read_loops_0_dimensionality"] = 0
    config["agg_read_output_sched_gen_sched_addr_gen_strides_0"] = 0
    ...
    config["port_sel_addr_strides_0"] = 0
    config["port_sel_addr_strides_1"] = 0
    config["port_sel_addr_strides_2"] = 0
    config["port_sel_addr_strides_3"] = 0
    config["port_sel_addr_strides_4"] = 0
    config["port_sel_addr_strides_5"] = 0
    config["agg_write_addr_gen_1_strides_0"] = 15
    config["agg_write_addr_gen_1_strides_1"] = 0
    config["agg_write_addr_gen_1_strides_2"] = 1
    config["agg_write_addr_gen_1_strides_3"] = 65528
    config["agg_write_addr_gen_1_strides_4"] = 12
    config["agg_write_addr_gen_1_strides_5"] = 0
    config["agg_write_addr_gen_0_starting_addr"] = 13
    config["agg_read_addr_gen_0_starting_addr"] = 3
    config["agg_write_sched_gen_1_sched_addr_gen_strides_0"] = 2
    config["agg_write_sched_gen_1_sched_addr_gen_strides_1"] = 0
    config["agg_write_sched_gen_1_sched_addr_gen_strides_2"] = 65535
    config["agg_write_sched_gen_1_sched_addr_gen_strides_3"] = 65535
    config["agg_write_sched_gen_1_sched_addr_gen_strides_4"] = 0
    config["agg_write_sched_gen_1_sched_addr_gen_strides_5"] = 0
    config["agg_read_addr_gen_0_strides_0"] = 0
    ...
    config["agg_write_sched_gen_0_sched_addr_gen_strides_2"] = 65535
    config["agg_write_sched_gen_0_sched_addr_gen_strides_3"] = 65535
    config["agg_write_sched_gen_0_sched_addr_gen_strides_4"] = 0
    config["agg_write_sched_gen_0_sched_addr_gen_strides_5"] = 0
    config["agg_write_sched_gen_0_sched_addr_gen_starting_addr"] = 1
    config["agg_write_loops_0_ranges_0"] = 0
    config["agg_write_loops_0_ranges_1"] = 0
    config["agg_write_loops_0_ranges_2"] = 1
    config["agg_write_loops_0_ranges_3"] = 65535
