...
def test_identity_stream(num_tiles=2,
    ...
    for i in range(num_tiles):
        ...
        new_config[f"tile_{i}_strg_ub_input_addr_ctrl_address_gen_0_ranges_0"] = 12
        ...
        new_config[f"tile_{i}_strg_ub_tba_0_tb_0_indices_2"] = 2
        new_config[f"tile_{i}_strg_ub_tba_0_tb_0_indices_3"] = 3
        new_config[f"tile_{i}_strg_ub_tba_0_tb_0_range_inner"] = 4
