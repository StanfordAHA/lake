...
weights_params = make_params("weights", 512, read_write_port_width=1)
...
accum_params = make_params("accum", 64, read_write_port_width=1)
...
input_params = make_params("input_buffer", 1024, read_write_port_width=1)
