...
# =============================
        ...
        # Stupid convert
        self._pos_in_us_packed = self.var("fifo_us_in_packed", self.data_width + 2, packed=True)
        ...
        self._data_out_us_packed = self.var("fifo_out_us_packed", self.data_width + 2, packed=True)
