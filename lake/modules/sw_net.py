...
class SW_NET(Generator):
    ...
    def __init__(self,
        ...
        self._data_in = self.input("data_in", data_width, size=interconnect_in, packed=True, explicit_array=True) # Actually an array
        ...
        # Somehow get data to the output -> probably with an address -> which will be 0-num_aggregators
