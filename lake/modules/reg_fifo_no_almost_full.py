...
class RegFIFO_no_almost_full(Generator):
    '''
    ...
    def update_name(self):
        self.name = f"reg_fifo_depth_{self.depth}_w_{self.data_width}_no_almost_full"
...
if __name__ == "__main__":
    # dut = RegFIFO_no_almost_full(data_width=16,
    #               depth=64,
    #               width_mult=4)
    # verilog(dut, filename="reg_fifo_no_defer.sv")

    dut2 = RegFIFO_no_almost_full(data_width=16,
                   depth=64,
                   width_mult=4,
