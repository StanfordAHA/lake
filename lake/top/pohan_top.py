...
class PohanTop():
    ...
    def make_wrapper(self, to_wrap, mode="UB", cfg_dict={}, wrapper_name=""):
    ...
    def wrapper(self, base_vlog_filename="default_wrapper",
        ...
        wrapper = self.make_wrapper(to_wrap=flattened_gen, mode=mode, cfg_dict=cfg_dict, wrapper_name=wrapper_vlog_filename)
        verilog(wrapper, filename=f"LakeWrapper_{wrapper_vlog_filename}.v")
