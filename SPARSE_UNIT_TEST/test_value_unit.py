...
# def test_iter_basic():
#     init_module()
#     test_list = ["direct_1d", "direct_2d", "in_ref_2d_1", "in_ref_2d_2", "in_ref_empty_fiber", "arr_1", "arr_2", "arr_3", "arr_4", "arr_5",  "arr_6", "nothing", "xxx"]
...
def test_seq3():
    init_module()
    module_iter_basic("in_ref_2d_1", "nothing")
